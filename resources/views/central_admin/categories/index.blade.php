                ...
                <div class="overflow-x-auto">
                    <table id="categoriesTable" class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-gray-50">
                            ...
                            <tr class="hover:bg-indigo-50/30 transition-colors"
                                ...
                                <td class="py-4 px-5 text-center">
                                    <div class="flex items-center justify-center gap-2">
                                        <a href="{{ route('central_admin.categories.edit', $item) }}" class="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold text-indigo-700 bg-indigo-50 hover:bg-indigo-100 rounded-xl transition">
                                            <i class="fa-solid fa-pen-to-square"></i> แก้ไข
                                        </a>
                                        <form action="{{ route('central_admin.categories.destroy', $item) }}" method="POST" class="inline" onsubmit="return confirm('ยืนยันการลบหมวดหมู่ {{ $item->name }}?')">
                                            @csrf @method("DELETE")
                            ...
                            @empty
                            <tr><td colspan="3" class="py-14 text-center text-slate-400"><i class="fa-solid fa-folder-open text-4xl mb-2 block text-slate-300"></i>ยังไม่มีหมวดหมู่ในระบบ</td></tr>
                            @endforelse
                        </tbody>
                    </table>
                </div>
